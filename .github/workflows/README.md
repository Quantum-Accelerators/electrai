...
The e2e test (`scripts/e2e_train.py`) checks against platform-specific expected values in `tests/expected_values.json`. Different hardware produces slightly different floating-point results.
